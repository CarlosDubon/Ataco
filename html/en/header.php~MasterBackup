    ...
    <ul>
        ...
        <li class="submenu">
            ...
            <ul class="children">
                ...
                <li><a href="/Ataco/php/en/vivienda.php"><i class="fa fa-users" aria-hidden="true"></i>Población y Vivienda<i class="fa fa-ellipsis-h subitem" aria-hidden="true"></i></a></li>
            </ul>
        </li>
        <li class="submenu">
