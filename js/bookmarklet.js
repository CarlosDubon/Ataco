function ColorChange(VariableColor){
  ...
  var c = VariableColor; //-1 none; 0 protanopia; 1 protanomaly; 2 deuteranopia; 3 deuteranomaly; 4 tritanopia; 5 tritanomaly; 6 achromatopsia; 7 achromatomaly
  if (isNaN(c)) return;
