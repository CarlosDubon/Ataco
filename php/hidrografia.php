...
<body>
    ...
    <section>
        <div class="container">
            ...
            <h1 style="display: inline-block">Hidrografia 💧</h1>
            <div class="row">
              <div class="col-xs-12">
       ...
       <button type="button btn btn-large btn-success" class="play-buttom"><i name="play" class="fa fa-play" aria-hidden="true"></i>
